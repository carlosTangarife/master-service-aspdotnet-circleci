...
namespace Renting.MasterServices.Domain
{
    ...
    public class GestionFlotaTransContext : BaseDbContext
    {
        private readonly string connectionString;

        /// <summary>
        /// Initializes a new instance of the <see cref="GestionFlotaTransContext"/> class.
        /// </summary>
        /// <param name="connectionString">The connection string.</param>
        public GestionFlotaTransContext(string connectionString)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Announcement>().ToTable("tblAnuncios");
