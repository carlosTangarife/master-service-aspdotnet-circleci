...
namespace Renting.MasterServices.Domain
{
    ...
    public class GestionFlotaContext : BaseDbContext
    {
        private readonly string connectionString;

        /// <summary>
        /// Initializes a new instance of the <see cref="GestionFlotaContext"/> class.
        /// </summary>
        /// <param name="connectionString">The connection string.</param>
        public GestionFlotaContext(string connectionString)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Parameter>().ToTable("tblSGSParametro").HasKey(x => x.Id);

            modelBuilder.Query<Plate>();
            modelBuilder.Query<VehicleType>();
