...
{
    public class SurentingContext : DbContext, IQueryableUnitOfWork
    {
        private readonly string connectionString;

        public SurentingContext(string connectionString)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<State>().ToTable("tblEstados").HasKey(x => x.Id);
            modelBuilder.Query<EconomicGroup>();
            modelBuilder.Query<ClientUser>();
            modelBuilder.Entity<Provider>().ToTable("tblProveedores").HasKey(x => x.Id);
